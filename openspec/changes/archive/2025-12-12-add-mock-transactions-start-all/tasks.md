...
- [x] 1.5 Validar manualmente executando o script e verificando que o `Mock.Transactions` está rodando e publicando mensagens (pendente: validação manual não executada neste ambiente).
