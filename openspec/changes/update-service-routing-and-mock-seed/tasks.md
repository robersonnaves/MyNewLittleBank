...
- [ ] 1.5 Adicionar testes (ou smoke) que garantam rejeição/ignorância segura para tipos incorretos.
...
- [ ] 2.4 Validar manualmente (ou via teste) que o seed cria 10 clientes e cada cliente tem 1-3 contas antes de publicar transações.
